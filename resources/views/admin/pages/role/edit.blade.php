...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-5">Edit Role</h4>
                    <form action="{{ route('admin.roles.update', $item->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                                            ...
                                            @forelse($group as $permission)
                                                <label class="pr-3">
                                                    <input name="permissions[]" class="permissioncheckbox"
                                                        ...
                                                        {{ in_array($permission->name, $item->permissions->pluck('name')->toArray()) ? 'checked' : '' }}>
                                                    {{ $permission->name }} &nbsp;&nbsp;
                                                </label>
                                            @empty
