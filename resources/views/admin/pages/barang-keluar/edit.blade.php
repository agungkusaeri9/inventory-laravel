...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-5">Edit Barang Keluar</h4>
                    <form action="{{ route('admin.barang-keluar.update', $item->id) }}" method="post">
                        @csrf
                        @method('patch')
                        ...
                        <div class="form-group text-right">
                            ...
                            <button class="btn btn-primary">Update Barang Keluar</button>
                        </div>
                    </form>
                </div>
            </div>
