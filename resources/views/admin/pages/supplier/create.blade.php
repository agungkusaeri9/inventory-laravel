...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-5">Tambah Supplier</h4>
                    <form action="{{ route('admin.supplier.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class='form-group mb-3'>
                            <label for='nomor_fax' class='mb-2'>Nomor Fax</label>
                            <input type='text' name='nomor_fax'
                        ...
                        <div class="form-group text-right">
                            <a href="{{ route('admin.supplier.index') }}" class="btn btn-warning">Batal</a>
